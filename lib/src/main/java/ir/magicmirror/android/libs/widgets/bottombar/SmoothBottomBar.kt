...
class SmoothBottomBar @JvmOverloads constructor(
    ...
    private var activeItemWidth: Float = 0F
    ...
    @Dimension
    private var _itemIconSizeActive = context.d2p(DEFAULT_ACTIVE_ICON_SIZE)
    ...
    var itemIconSizeActive: Float
        @Dimension get() = _itemIconSizeActive
        set(@Dimension value) {
            _itemIconSizeActive = value
            invalidate()
        }
    ...
    private fun obtainStyledAttributes(attrs: AttributeSet?, defStyleAttr: Int) {
        ...
        try {
            ...
            itemIconSizeActive = typedArray.getDimension(
                R.styleable.SmoothBottomBar_iconSizeActive,
                itemIconSizeActive
            )
    ...
    override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
        ...
        for ((index, item) in items.withIndex()) {
            if (index == itemActiveIndex) {
                item.rect = RectF(lastX, 0f, activeItemWidth + lastX, height.toFloat())
                lastX += activeItemWidth
            } else {
    ...
    companion object {
        ...
        private const val DEFAULT_ACTIVE_ICON_SIZE = 16F
